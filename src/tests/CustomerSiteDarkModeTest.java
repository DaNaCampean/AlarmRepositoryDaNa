...
//        siteAppearance.darkModeClick();
        ...
        if (attribute.equals("false"))
        {
            ...
            System.out.println("check if DarkMode toggle is BLUE");

            Color darkToggleColor = siteAppearance.darkModeToggleBlue(); // Verified that the DARK MOdetoggle  is BLUE, by checking outline-color using rgba function
        ...
        System.out.println("START CHECK IF IT IS BLUE");
        ...
        System.out.println("STEP - Passed - The High Contrast is BLUE, by checking outline-color css element using rgba function ");
